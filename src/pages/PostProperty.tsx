...
const PostProperty = () => {
  ...
  const hyderabadAreas = [
    ...
    'Chevella', 'Chilkuru', 'Chinthal', 'Chintakunta', 'Choutuppal', 'Czech Colony', 'Dammaiguda', 'Dilsukhnagar',
    ...
    'Sanathnagar', 'Sangareddy', 'Saroornagar', 'Sathupalli', 'Secunderabad', 'Serilingampally', 'Shadnagar', 
